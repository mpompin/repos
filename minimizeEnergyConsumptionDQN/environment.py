...
class Environment(object):
    ...
    def __init__(self, optimal_temperature= (18.0, 24.0), initial_month =0, initial_number_users = 10, initial_rate_data = 60):
        self.monthly_atmospheric_temperatures = [1.0, 5.0, 7.0, 10.0, 11., 20., 23., 24., 22., 10., 5., 1.]
    ...
    #METHOD THAT UPDATES THE ENVIRONMENT RIGHT AFTER AGENT PLAYS AN ACTION
    def update_env(self, direction, energy_ai, month):
        ...
        #compute delta temperature due to ai
        if direction == -1:
            delta_temperature_ai = -energy_ai
        elif direction == 1:
            delta_temperature_ai = energy_ai
        #update server temperature when ai
        self.temperature_ai += delta_intrinsic_temperature + delta_temperature_ai
        #update server temperature when no ai
        ...
        #update total energy spent when noai
    ...
    #METHOD GIVES CURRENT STATE, LAST REWARD and whether the game is finished
    def observe(self):
        scaled_temperature_ai = (self.temperature_ai - self.min_temperature)/ (self.max_temperature - self.min_temperature)
        scaled_number_users = (self.current_number_users - self.min_number_users)/ (self.max_number_users - self.min_number_users)
        scaled_rate_data = (self.current_rate_data - self.min_rate_data)/ (self.max_rate_data - self.min_rate_data)
